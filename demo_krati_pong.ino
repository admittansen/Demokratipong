...
#define WHEEL_ONE_PIN 3 //analog  //BLÅ
#define WHEEL_TWO_PIN 1 //analog //RÖD
#define BUTTON_ONE_PIN A4 //digital 
#define BUTTON_TWO_PIN A4 //digital 
...
static const char str10[] PROGMEM=" ADMITTANSENS  "; 
static const char str11[] PROGMEM="DEMO-KRATI PONG"; 
static const char str15[] PROGMEM="Red wins!"; 
static const char str16[] PROGMEM="Blue wins!"; 
...
void processInputs() {
  ...
  wheelOnePosition = wheelOnePosition*2;
  wheelTwoPosition = wheelTwoPosition*2;
  
  if(wheelOnePosition > 1023) wheelOnePosition = 1023;
  
  if(wheelTwoPosition > 1023) wheelTwoPosition = 1023;
